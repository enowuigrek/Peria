...
export default function Inbox() {
    ...
    return (
      <div className={styles.emptyState}>
        <div className={styles.emptyIcon}>
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.35">
  ...
  const renderNote = (note) => {
          ...
          const hasContent = note.detected?.note || checklistHasItems(note.detected) || note.detected?.events?.length > 0
